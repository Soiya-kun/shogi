...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| PC全景 | 392 | 0 | 230 | 597,047 | 13.26ms | 13.4ms |
| PC接近 | 392 | 24 | 197 | 929,946 | 13.20ms | 13.5ms |
| スマホ幅・全景 | 240 | 0 | 234 | 505,819 | 13.31ms | 13.4ms |
...
実機スマホ・Safariの性能と2本指ジェスチャーの実機確認は未実施。兵士は戦国風のオリジナルモデルを使い、骨格リグやモーションキャプチャは導入していない。CPU、オンライン対局、時計、持将棋、入玉宣言は今回の対象外。
